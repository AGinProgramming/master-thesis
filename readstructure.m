...
rootDir_DCEpeak = 'C:\Users\alexg\Desktop\study\graduationproject\code\featuremaps76\DCEpeak\';
rootDir_DCEwashin = 'C:\Users\alexg\Desktop\study\graduationproject\code\featuremaps76\DCEwashin\';
rootDir_T2 = 'C:\Users\alexg\Desktop\study\graduationproject\code\featuremaps76\T2\';
...
%% data save
% 将矩阵保存为.mat文件
output_file_DCEwashin = 'G:\Code\Hesheng Gong - code\feature_map_all_DCEwashin.mat';
save(output_file_DCEwashin, 'X_DCEwashin');

fprintf('Feature matrix saved to %s\n', output_file_DCEwashin);

output_file_DCEwashin = 'G:\Code\Hesheng Gong - code\feature_map_all_DCEwashin.xlsx';
writematrix(X_DCEwashin, output_file_DCEwashin);

fprintf('Feature matrix saved to %s\n', output_file_DCEwashin);
%%
output_file_DCEpeak = 'G:\Code\Hesheng Gong - code\feature_map_all_DCEpeak.mat';
save(output_file_DCEpeak, 'X_DCEpeak');

fprintf('Feature matrix saved to %s\n', output_file_DCEpeak);

output_file_DCEpeak = 'G:\Code\Hesheng Gong - code\feature_map_all_DCEpeak.xlsx';
writematrix(X_DCEpeak, output_file_DCEpeak);

fprintf('Feature matrix saved to %s\n', output_file_DCEpeak);
%%
output_file_ADC = 'G:\Code\Hesheng Gong - code\feature_map_all_ADC.mat';
save(output_file_ADC, 'X_ADC');

fprintf('Feature matrix saved to %s\n', output_file_ADC);

output_file_ADC = 'G:\Code\Hesheng Gong - code\feature_map_all_ADC.xlsx';
writematrix(X_ADC, output_file_ADC);

fprintf('Feature matrix saved to %s\n', output_file_ADC);
%%
output_file_T2 = 'G:\Code\Hesheng Gong - code\feature_map_all_T2.mat';
save(output_file_T2, 'X_T2');

fprintf('Feature matrix saved to %s\n', output_file_T2);

output_file_T2 = 'G:\Code\Hesheng Gong - code\feature_map_all_T2.xlsx';
...
save_dir = 'G:\Code\Hesheng Gong - code';
outputFileName = 'grayscale_map.xlsx';
